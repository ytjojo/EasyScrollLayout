...
public class VerticalScrollCheckHandlar {
    ...
    private void onViewpagerFound() {
        ...
        if (a instanceof FragmentPagerAdapter) {
            ...
            findScrollView(item.getView(), 0);
        } else if (a instanceof ScrollMasterView.CurrentPagerAdapter) {
            final ScrollMasterView.CurrentPagerAdapter adapter = (ScrollMasterView.CurrentPagerAdapter) a;
        ...
        public void onPageScrollStateChanged(int state) {
            if (state == ViewPager.SCROLL_STATE_IDLE) {
                ...
                if (a instanceof FragmentPagerAdapter) {
                    ...
                    ScrollMasterView.CurrentPagerAdapter currentPagerAdapter = (ScrollMasterView.CurrentPagerAdapter) a;
