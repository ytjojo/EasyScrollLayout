...
public class HorizentalLoadItemActivity extends AppCompatActivity {
    ...
    ScrollMasterView mMainEasyScrollLayout;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_recylerview);
        mMainEasyScrollLayout = (ScrollMasterView) findViewById(R.id.StickyNavLayout);
    ...
    private View getHeader() {
        final ScrollMasterView easyScrollLayout = (ScrollMasterView) LayoutInflater.from(this).inflate(R.layout.item_header_recyclerview, recyclerView, false);
